...
<div>
  <div class="preview flex min-h-[50px] w-full justify-center p-10 items-center">
    <a href="https://www.shadcn-vue.com/docs/components/hover-card"  target="_blank" class="text-blue-500 hover:underline">component docs</a>
    <div class="w-8"/>
    <a href=""  target="_blank" class="text-blue-500 hover:underline">api docs</a>
  </div>
        ...
        <div class="group relative flex h-full w-full flex-col justify-end overflow-hidden">
          ...
          >
            ...
            <div class="mt-5 hidden transition-all group-hover:block">
              <UiButton class="w-full dark:bg-primary-foreground dark:text-primary">View profile</UiButton>
            </div>
          </div>
        </div>
      </UiHoverCardContent>
